    ...
    <div class="col-lg-12">
        <div class="ibox">
            ...
            <div class="ibox-content">
                ...
                <form action="{{ route('blogs-store') }}" novalidate method="post" id="addRecord" enctype="multipart/form-data">
                    @csrf
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" required name="subtitle" placeholder="Enter the Short Description" rows="2"></textarea>
                        ...
                        <div class="col-md-6 my-auto">
                            <label for="editImage" style="cursor: pointer;" class="form-label float-right float-end">
                                ...
                                <div id="cropContainer my-auto">
                                    <img id="imageView" src="{{asset('/uploads/profile/cover-avatar.png')}}" style=" width:450px; height: auto;" alt="Image View">
                                </div>
                        </div>
                        </label>
                    </div>
                    <div class="row mb-3">
                        <div class="mb-3">
                            <div class="row">
                                ...
                                <select class="form-select" required name="categories[]" id="categories" multiple aria-label="multiple select example" required>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" required id="content" name="description" placeholder="Enter the Description" rows="10"></textarea>
                        </div>
                    </div>
