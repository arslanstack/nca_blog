...
<head>
	...
	<meta name="description" content="NCA - Taking success to the next level.">
...
})(window,document,'script','dataLayer','GTM-PMVD7NQ');</script>
<!-- End Google Tag Manager -->
</head>
<body class="landing_page_body h-vh">
				...
				<div class="container-inner-1400 m-auto">
					<div class="row align-items-center">
						...
						<div class="brk-header__item d-flex landing_lng justify-content-center">
							<a href="index.php" class="bg-transparent btn btn-prime btn-sm border-radius-25 font__weight-bold shadow-none header_btn" data-brk-library="component__button">English</a>
						</div>
						</div>
					</div>
					</div>
